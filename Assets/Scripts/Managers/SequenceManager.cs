...
namespace rpg.ui
{
    ...
    public class SequenceManager : MonoBehaviour
    {
        ...
        IState m_CharacterSelectionState;   // Show a UI Screen to choose a game mode/level
        ...
        private void SetStates()
        {
            ...
            m_CharacterSelectionState = new State(null, "LevelSelectionState", m_Debug);
        ...
        private void AddLinks()
        {
            ...
            m_MainMenuState.AddLink(new EventLink(characterSelectionShownWrapper, m_CharacterSelectionState));
            ...
            m_CharacterSelectionState.AddLink(new EventLink(screenClosedWrapper, m_MainMenuState));
            m_CharacterSelectionState.AddLink(new EventLink(gameStartedWrapper, m_GamePlayState));
